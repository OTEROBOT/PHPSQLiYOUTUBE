...
if (!$_SESSION["emp_id"]) {
    ...
    <div class="container">
        <h2>ยินดีต้อนรับ [ Administrator ] </h2>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="indexadmin.php?emp_id=<?php echo htmlspecialchars($row["emp_id"]); ?>" class="btn btn-success">แก้ไข</a></td>
                        <!-- ลบข้อมูลถูกลบออกไปแล้ว -->
                    </tr>
                </tbody>
            </table>
