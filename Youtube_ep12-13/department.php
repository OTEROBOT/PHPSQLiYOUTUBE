...
// แก้ไขตัวแปร $sql และลบตัวอักษร I ที่เกินมา
$sql = "SELECT department.d_name, employee.emp_title, employee.emp_name, employee.emp_surname, 
    employee.emp_id, employee.emp_tel 
    FROM department 
    INNER JOIN employee ON department.d_id = employee.d_id";

// ใช้ตัวแปร $sql ใน mysqli_query
