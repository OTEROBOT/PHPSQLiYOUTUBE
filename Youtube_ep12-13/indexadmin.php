                ...
                <?php if ($count > 0) {
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <tr>
                            ...
                            <!-- ลบข้อมูล -->
                            <td><a href="deletedata.php?emp_id=<?php echo $row["emp_id"]; ?>" class="btn btn-danger"
                            onclick="return confirm('ยืนยันการลบข้อมูล')">ลบ</a></td>
                        </tr>
                    <?php }
                } else { ?>
                    <tr>
                        <td colspan="10" class="text-center">ไม่มีข้อมูลพนักงาน</td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
